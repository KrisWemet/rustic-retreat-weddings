...
const getKeywordCluster = (normalizedQuestion: string) => {
  const keywordClusters: Array<{ cluster: string; keywords: string[] }> = [
    ...
    { cluster: "Amenities & Facilities", keywords: ["amenities", "water", "power", "electric", "bathroom", "shower", "hot water", "wash house", "bridal suite", "getting ready", "hair", "makeup", "wifi", "outhouse"] },
