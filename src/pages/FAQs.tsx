...
const FAQs = () => {
  const faqs: FAQEntry[] = [
    ...
    },
    {
      ...
      answer: "We want to be upfront with you on this one — we are a natural, off-grid property, and nature doesn’t come with smooth, even surfaces. The grounds are a mix of grass, gravel, and wood chips, and as beautiful as that is, it does mean that full accessibility cannot be guaranteed.\n\nThat said, we will absolutely do everything we can to help make your celebration as inclusive as possible. If you have guests with mobility needs, we encourage you to think through your layout, parking, and seating flow early in your planning — and if you’d like, we’re happy to offer suggestions based on the property to help point you in the right direction.\n\nPlease note that we do not currently have wheelchair accessible washroom facilities on site. This is something we are mindful of as we continue to grow and develop the property."
    },
    {
    ...
    },
    {
      ...
      answer: "A spotless deep clean is not expected — we take care of that between bookings. What we do ask is that the property is left tidy and respectful for the next couple who will be calling it home.\n\nSince you’re welcome to arrange the gazebo layout and ceremony spaces to suit your vision, we simply ask that all picnic tables, ceremony benches and venue items are returned to their original check-in locations before you leave.\n\nThe cabin, bridal suite, and grounds should be left tidy. All cabin dishes should be washed and put away. Garbage bags should be tied up and placed in the designated area. Before checkout, please do a thorough walkthrough of the camping area, ceremony space, gazebo, and fire pit area to ensure all garbage, confetti, and décor has been cleared.\n\nAll borrowed décor items must be cleaned (if applicable) and returned to the décor shed in their appropriate labelled bins. If anything has been damaged or is missing, please let us know before checkout rather than leaving us to discover it after — we truly appreciate the honesty and it makes the process much smoother for everyone.\n\nAll personal items, rental items, and any items brought in by vendors should be fully packed out. Hosts are responsible for ensuring their guests and vendors have cleaned up as well.\n\nExcessive cleanup required after checkout will result in a cleaning fee deducted from your damage deposit, as outlined in your contract.\n\nIf you’re ever unsure about anything during teardown, just ask — we’d rather answer a quick question than have you stress about it."
    },
    {
      category: "Property Rules & Policies",
      question: "Are there décor restrictions like candles, confetti, tape, nails, or sparklers?",
      answer: "There are a few things worth knowing to keep the property beautiful and everyone safe — and honestly, none of them should get in the way of your vision.\n\nOpen flame is welcome but must follow fire safety guidelines. Real candles must be stable and attended at all times. During fire advisories or bans, flame-based options may be restricted, and flameless candles are always a gorgeous alternative.\n\nLoose confetti and glitter are not permitted on the property — they’re tricky to clean from grass and gravel and can be harmful to local wildlife. Natural alternatives such as dried flowers or rice paper confetti are welcome, as they break down quickly and beautifully. We do ask that your best efforts are made to clean up the majority before checkout.\n\nNothing may be nailed, screwed, or stapled into any building, structure, tree, arch, or table on the property. Instead, please use non-damaging and fully removable fasteners such as twine or zip ties. All fasteners must be removed prior to checkout — a quick sweep during teardown goes a long way.\n\nIf you’re ever unsure whether a décor idea is property-friendly, just send it our way ahead of time. We love a creative vision and we’ll always do our best to help you find a beautiful way to make it work.\n\nYou can review the full Rustic Retreat Site Rules & Guidelines via the link below.",
