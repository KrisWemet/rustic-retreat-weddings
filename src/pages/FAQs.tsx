...
const FAQs = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "More than you'd expect. Probably more than you've seen anywhere else.\n\nThe venue grounds are yours for the full weekend: the ceremony spaces, the clear-top gazebo, the groomed trails winding through the property, and the campfire areas. We live here and we're close by if you need us, but this weekend belongs to you. We'll make ourselves scarce.\n\nFor the celebration itself, you'll have an outdoor dance floor, a Bluetooth sound system with wireless microphones, and picnic tables and hand-crafted rustic ceremony benches for up to 80 guests, set up wherever the day calls for them.\n\nOur Wedding Décor Collection is yours at no extra cost: wooden arches, table styling pieces, and a collection that keeps growing because we keep finding things we love. Tell us your vision and we'll point you to what works. A small selection of consumables like candles and batteries are available if you need them.\n\nThe newlywed cabin is stocked and waiting. Comfortable bedding, a Keurig with pods, cookware, and everything you need for a slow, quiet morning after. It's private, it's cozy, and it's the perfect place to exhale after the best day of your life.\n\nFirewood and a propane BBQ are included for meals, gatherings, and the kind of late-night fires nobody wants to leave. And when the chickens are cooperating, fresh eggs in the morning — the detail guests always seem to mention when they tell people about Rustic Retreat.\n\nFor families bringing little ones, the property takes care of them: a trampoline, a playhouse, lawn games, and a stash of board games for rainy afternoons. Happy kids mean relaxed parents, and relaxed parents make for a better wedding."
    },
    {
