...
const FAQs = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Quite a lot, actually.\n\nThe venue grounds are yours for the full duration of your package: the ceremony spaces, the clear-top gazebo, the groomed trails, the campfire areas, and everything in between. We live on the property and are nearby if you need anything, but we stay out of your way so the weekend truly feels like yours.\n\nFor the celebration itself, you'll have an outdoor dance floor, a Bluetooth two-speaker sound system with wireless microphones, and picnic tables and rustic ceremony benches for up to 80 guests, ready to be placed wherever you need them to go.\n\nYou also get full access to our Wedding Décor Collection: arch options, table styling pieces, and more, all at no extra cost. It's a living collection that keeps growing.\n\nThe newlywed cabin is yours for the weekend, stocked with everything you need to feel at home: a Keurig with pods, cookware, comfortable bedding, and all the basics for a relaxed morning after. It's cozy, it's private, and it's the perfect place to close out the best day of your life.\n\nFirewood and a BBQ with propane are included for all those meals and late-night fires. Oh, and farm-fresh eggs when the chickens are laying. It's one of those little things guests always remember.\n\nFor the little ones (and the young at heart), there's a trampoline, a playhouse, a full lineup of lawn games, and a selection of board games for rainy days or whenever the mood strikes.\n\nConsumables like batteries and candles are available for an additional fee."
    },
    {
