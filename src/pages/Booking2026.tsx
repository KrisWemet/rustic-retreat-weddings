...
const packages = [
  { label: '2-Day Weekday', price: '$3,000', value: '2-Day Weekday ($3,000)' },
  { label: '3-Day Weekend', price: '$4,500', value: '3-Day Weekend ($4,500)' },
  { label: '5-Day Weekend', price: '$5,500', value: '5-Day Weekend ($5,500)' },
];
...
export default function Booking2026() {
  ...
  if (status === 'success') {
    return (
      <>
        <SEO
          title="2026 Booking Form - Rustic Retreat Weddings"
          description="Complete your 2026 wedding booking questionnaire for Rustic Retreat."
          noindex={true}
        />
